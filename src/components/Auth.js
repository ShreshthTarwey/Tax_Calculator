      ...
      >
        ...
        <div className="mt-4">
          <button
            ...
            disabled={loading}
            className="w-full bg-white hover:bg-gray-100 text-gray-900 py-2 rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center space-x-2"
          >
